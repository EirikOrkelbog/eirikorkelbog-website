		...
		<section className='py-12 xl:py-24 min-h-[84vh] xl:pt-28 bg-hero bg-no-repeat bg-bottom bg-cover'>
			<div className='container mx-auto'>
					<div className='flex max-w-[1000px] flex-col items-center mx-auto text-center'>
						...
						<p className='subtitle max-w-[490px] mx-auto xl:mx-0'>I help fashion e-commerce brands drive traffic, capture leads, and convert more customers — without hiring a $5k/month agency.</p>
